        ...
        <div className="flex flex-col items-center gap-8 text-center">
          ...
          <div className="w-full max-w-sm">
            <button
              ...
              className="w-full px-8 py-3 bg-gray-600 text-white font-semibold rounded-full shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
            >
              Don't have a brief? Make one here
            </button>
          </div>
